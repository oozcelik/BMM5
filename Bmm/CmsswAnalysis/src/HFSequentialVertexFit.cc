...
extern HFTrackListBuilder  *fListBuilder;
...
if (1) {
   ...
   cout << "XXXXXXXXX doca: " << md.distance() << " " << md2.distance() << endl;
 }*/

  return pCand;
}

float HFSequentialVertexFit::getScale(HFTrackListBuilder *fListBuilder){
 TLorentzVector p4m1, p4m2, p4psi, m1best, m2best;
 AnalyticalImpactPointExtrapolator extrapolator(fMagneticField);
 float doca;
 double mbest(-999.);
